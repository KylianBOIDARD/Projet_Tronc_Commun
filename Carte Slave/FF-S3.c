...
/*
void main(){
	P0MDOUT |= 0x01; //set P0.0 state to push-pull
	Init_FF_S3();
	while(1){
...
unsigned char CDE_Servo_V (char Angle){ //Angle ira de -90° à 90°
	dutycycle=Angle/33.6+1.69;

	PWM=(dutycycle/100)*65536;

	temps_deplacement = 0.21 * ( AngleConvert - AncienAngle ) / 60; //En secondes, 0.21 = 0.21 sec/60° du servomoteur HS-422
	AncienAngle = AngleConvert;
